...
class ticket_system_rep(commands.Cog):
    ...
    async def ticket_system_rep(self, ctx: commands.Context):
...
( **__Только для машин с двигателем__** ) [ *Обговаривать на месте* ]
        ...
        print(f"{Fore.RED}{ctx.author.name} {Fore.YELLOW}created ticket system ( Починка Двигателя ): {Fore.GREEN}ticket_system_rep{Fore.RESET}")

...
- *от 1 часа до 7 дней* (**__Спрашивайте отдельно__**)
        ...
        print(f"{Fore.RED}{ctx.author.name} {Fore.YELLOW}created ticket system ( Аренда Авто ): {Fore.GREEN}ticket_system_set{Fore.RESET}")
...
""")
            ...
            message_id_control = await control_message.send('<@&1204255065804636261>',embed=embed_message_control_tickets, view=buttons_on_control_ticket_by_moderator())
...
""", color=discord.Colour.red())
                    embed_for_user.set_image(url="https://i.imgur.com/sOyS2oX.png")
